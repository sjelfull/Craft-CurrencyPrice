 ...
 *
 * Fieldtype that allow you to set the price for multiple currencies.
 *
 * --snip--
...
class CurrencyPricePlugin extends BasePlugin
{
    ...
    {
        return Craft::t('Fieldtype that allow you to input a price in multiple currencies.');
    }
    ...
    {
        return 'https://github.com/sjelfull/Craft-CurrencyPrice/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/sjelfull/Craft-CurrencyPrice/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.currencyprice.twigextensions.CurrencyPriceTwigExtension');

        return new CurrencyPriceTwigExtension();
    }
    */
